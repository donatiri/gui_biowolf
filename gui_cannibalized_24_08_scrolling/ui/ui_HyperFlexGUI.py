...
class Ui_HyperFlexGUI(object):
    def setupUi(self, HyperFlexGUI):
        ...
        self.gridLayout.addWidget(self.plot, 0, 0, 10, 10)
        ...
        self.gridLayout.addWidget(self.effortLabel, 12, 0, 0, 0) 
#        self.gridLayout.addWidget(self.effortLabel, 12, 0, 1, 1) 
        ...
        self.gridLayout.addWidget(self.effort, 12, 1, 0, 0)
        ...
        self.gridLayout.addWidget(self.targetLabel, 13, 0, 0,0) 
#        self.gridLayout.addWidget(self.targetLabel, 13, 0, 1, 1) 
        ...
        self.gridLayout.addWidget(self.target, 13, 1, 0, 0)
#        self.gridLayout.addWidget(self.target, 13, 1, 1, 4)
     ...
     #   self.gridLayout.addWidget(self.mLabel, 14, 1, 1, 1)
        self.gridLayout.addWidget(self.mLabel, 14, 1, 0,0)
        ...
        self.gridLayout.addWidget(self.m, 14, 2, 0,0)
#        self.gridLayout.addWidget(self.m, 14, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.bLabel, 14, 3, 0,0)
#        self.gridLayout.addWidget(self.bLabel, 14, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.b, 14, 4, 0,0)
#        self.gridLayout.addWidget(self.b, 14, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.message, 0, 5, 0,0)
        ...
        self.gridLayout.addWidget(self.image, 2,7,0,0)
        ...
        self.gridLayout.addWidget(self.posImage, 2,5,0,0)
        ...
        self.gridLayout.addWidget(self.gestureSets, 11,5,0,0)
        ...
        self.gridLayout.addWidget(self.position, 11,6,0,0)
...
#        self.gridLayout.addWidget(self.timeRelaxLabel, 10, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.timeRelax, 11, 9, 0,0)
#        self.gridLayout.addWidget(self.timeRelax, 11, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.timeTransLabel, 10, 10, 0,0)
        ...
        self.gridLayout.addWidget(self.timeTrans, 11, 10, 0,0)
        ...
        self.gridLayout.addWidget(self.subInd, 12, 6, 0, 0)
...
#        self.gridLayout.addWidget(self.saveData, 12, 9, 1, 1)
       ...
       # self.gridLayout.addWidget(self.wideDisable, 12, 10, 1, 1)
        self.gridLayout.addWidget(self.wideDisable, 12, 10, 0,0)
        ...
        self.gridLayout.addWidget(self.description, 13, 6, 0,0)
       # self.gridLayout.addWidget(self.description, 13, 6, 1, 5)
        ...
        self.gridLayout.addWidget(self.hdMode, 14, 6, 0, 0)
...
'''
        ...
        self.gestureSetsLabel.setText(_translate("Experiment", "", None))
        self.positionLabel.setText(_translate("Experiment", "", None))
        self.numRepsLabel.setText(_translate("Experiment", "", None))
        self.timeGestLabel.setText(_translate("Experiment", "", None))
        self.timeRelaxLabel.setText(_translate("Experiment", "", None))
        self.timeTransLabel.setText(_translate("Experiment", "", None))
        self.subIndLabel.setText(_translate("Experiment", "", None))
        self.expIndLabel.setText(_translate("Experiment", "", None))
        self.descriptionLabel.setText(_translate("Experiment", "", None))
        self.saveData.setText(_translate("Experiment", "Save Data", None))
        self.message.setText("Current gesture\nNext gesture in 5")
        self.wideDisable.setText(_translate("Experiment", "", None))
        self.hdModeLabel.setText(_translate("Experiment", "", None))

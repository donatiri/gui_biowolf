...
def cp2130_libusb_read(handle, datalen):
    ...
    error_code = libusb1.libusb_bulk_transfer(handle, 0x02, read_command_buf, sizeof(
    ...
    error_code = libusb1.libusb_bulk_transfer(handle, 0x81, read_input_buf, sizeof(
...
bytesnum = 200
buf = c_ubyte * 8
read_command_buf = buf(0x00, 0x00, 0x00, 0x00, bytesnum, 0x00, 0x00, 0x00)
bytesWritten = c_int()
buf = c_ubyte * bytesnum
read_input_buf = buf()
bytesRead = c_int()
usbTimeout = 0
while 1:
	libusb1.libusb_bulk_transfer(cp2130Handle, 0x02, read_command_buf, sizeof(read_command_buf), byref(bytesWritten), usbTimeout)
	libusb1.libusb_bulk_transfer(cp2130Handle, 0x81, read_input_buf, sizeof(read_input_buf), byref(bytesRead), usbTimeout)

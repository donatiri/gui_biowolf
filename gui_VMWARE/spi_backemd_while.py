...
buf = c_ubyte * 8
input_buf = c_ubyte * 14

read_command_buf = buf(0x00, 0x00,0x00,0x00,0x06, 0x00, 0x00, 0x00)
read_input_buf = input_buf(0x00, 0x00,0x00,0x00,0x00, 0x00,0x00, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00)
...
while 1:
	...
	error_code_read = libusb1.libusb_bulk_transfer(cp2130Handle, 0x02, read_input_buf, sizeof(read_input_buf), byref(bytesRead), 0)
